...
export const HeroSection = () => {
  ...
  return (
    <section className="section-padding" style={{ 
      ...
      <div className="max-container" style={{ position: 'relative', zIndex: 1, justifyContent: 'center', padding: '0 8px', maxWidth: '1600px' }}>
        <SectionReveal style={{ width: '100%', maxWidth: '1440px' }}>
          ...
          <div style={{ 
            ...
            padding: 'clamp(40px, 8vw, 80px) clamp(12px, 4vw, 80px)', /* Significantly reduced horizontal padding */
